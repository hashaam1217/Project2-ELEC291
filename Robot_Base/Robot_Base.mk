...
OBJS=main.o adc.o serial.o UART2.o startup.o newlib_stubs.o pwm.o init.o Period.o sweep.o rts.o
...
rts.o: rts.c
	$(CC) -c $(CCFLAGS) rts.c -o rts.o	

init.o: init.c
	$(CC) -c $(CCFLAGS) init.c -o init.o
	
Period.o: Period.c
	$(CC) -c $(CCFLAGS) Period.c -o Period.o
...
sweep.o: sweep.c
	$(CC) -c $(CCFLAGS) sweep.c -o sweep.o
